...
import com.it342.auth.dto.MessageResponse;
...
public class AuthController {
    ...
    /**
     * Logout: client should discard the JWT (stateless).
     * This endpoint returns a consistent success response for clients that call it.
     */
    @PostMapping("/logout")
